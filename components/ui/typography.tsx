  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "prose-li:marker:text-[var(--foreground)_!important]",
        "prose-a:font-medium prose-a:wrap-break-word prose-a:text-[var(--foreground)_!important] prose-a:underline prose-a:underline-offset-4",
      ...
      style={{ color: "var(--foreground) !important" }}
      {...props}
    />
  );
}
